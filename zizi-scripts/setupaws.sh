...
aws configure set default.region eu-west-1; aws configure set aws_access_key_id $key ; aws configure set aws_secret_access_key $skey; aws ecr get-login | sudo sh
