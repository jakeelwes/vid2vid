...
s3fs -o use_cache=/tmp/cache -o use_path_request_style zizi.data ~/vid2vid/zizi-data/ -o passwd_file=~/.passwd-s3fs -o url=https://s3-eu-west-1.amazonaws.com -o umask=0777,uid=$UID -o nonempty 
